...
export const projectsData = [
  ...
  },
  {
    ...
    details: [
      ...
      "After sign up email vertification is required to sign in done with firebase",
  ...
  },
  {
    ...
    details: [
      ...
      "it gives you top websites that have the name you searched, for instance if you search for (The dark) the result will be Transformers: Dark of the Moon(2011),The Dark Knight(2008),Thor: The Dark World(2013) and more",
      "the website provides many data about the movie or series like directors writers actors and others",
